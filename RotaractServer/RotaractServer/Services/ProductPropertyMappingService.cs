...
{
    public class ProductPropertyMappingService : IPropertyMappingService
    {
        private Dictionary<string, PropertyMappingValue> _productPropertyMapping =
             new Dictionary<string, PropertyMappingValue>(StringComparer.OrdinalIgnoreCase)
             {
               ...
               { "Inventory", new PropertyMappingValue(new List<string>() { "Inventory" }) }
             };
        ...
        {
            _propertyMappings.Add(new PropertyMapping<ProductsDto, Product>(_productPropertyMapping));
        }
